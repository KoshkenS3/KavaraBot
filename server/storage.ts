...
export class MemStorage implements IStorage {
  ...
  private initializeBoxes() {
    ...
    const readyBoxes: InsertBox[] = [
      {
        name: "БОКС ОГОНЬ",
        description: "Для комфортных занятий с максимальной производительностью",
        price: 9990,
      ...
      {
        name: "БОКС ЛЁДЕК",
        description: "Для комфортных занятий в прохладной цветовой гамме",
        price: 8490,
        imageUrl: "https://images.unsplash.com/photo-1506629905877-c1e5027f5b6c",
        contents: ["Спортивная футболка", "Спортивные шорты", "Кроссовки для фитнеса"],
        category: "ready",
        emoji: "❄️",
        isAvailable: true,
      },
      {
        name: "БОКС СТАРТ",
        description: "Идеальный набор для новичков в спорте",
        price: 6990,
        imageUrl: "https://images.unsplash.com/photo-1544966503-7cc5ac882d5a",
        contents: ["Базовая футболка", "Спортивные штаны", "Универсальные кроссовки"],
        category: "ready",
        emoji: "🌟",
        isAvailable: true,
      },
      ...
      {
        name: "БОКС ШТОРМ",
        description: "Мощный комплект для интенсивных тренировок",
        price: 11990,
        imageUrl: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd",
        contents: ["Компрессионная футболка", "Тренировочные шорты", "Профессиональные кроссовки"],
        category: "ready",
        emoji: "⛈️",
        isAvailable: false,
      },
      {
        name: "БОКС КОЛД",
        description: "Специально для холодной погоды",
        price: 13490,
        imageUrl: "https://images.unsplash.com/photo-1594736797933-d0b22ce8cd6c",
        contents: ["Утепленная куртка", "Термобелье", "Зимние кроссовки"],
        category: "ready",
        emoji: "🧊",
        isAvailable: false,
      },
